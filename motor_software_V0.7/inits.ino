...
void initAllMotors()
{
  ...
  #ifdef YAW
  //inits YAW
      initMotor(&initYaw, &yawEncoder, YAW_PLUS, YAW_MIN, YAW_ENABLE, LEFT, 75);// 70 was real
  ...
  //init elbow
      ...
      moveToPos(&yawTarget, (YAW_MAX_POS/2), &yawEncoder, YAW_PLUS, YAW_MIN, YAW_ENABLE, 70);//65 //70 was real
      delay(4200);
  #endif
  #ifdef ZED
  //inits ZED
